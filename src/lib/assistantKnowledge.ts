...
Les photos d’identité / scans ne sont pas stockés dans ClimaZEN. Sur chaque tech : bouton « Photos pièces » qui ouvre UNIQUEMENT le lien exact de CET opérateur (collé sous son nom dans Équipe). Si le dossier Drive est public (« toute personne avec le lien »), l’app arrête et n’ouvre rien — il faut Partager → Restreint, puis identifiant + mot de passe Drive.
