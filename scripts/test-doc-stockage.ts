...
assert.ok(tree.some((l) => l.includes('climazen-donnees.xlsx.enc')))
assert.ok(tree.some((l) => l.includes('queue_backup')))

assert.equal(COPIE_SECOURS_RELPATH, 'ClimaZEN/Documents/Secours/climazen-donnees.xlsx.enc')
