...
--
-- Chaque gérant colle SA clé OpenAI. ClimaZEN ne facture pas l’usage :
-- OpenAI facture le compte de la société.
-- La clé n’est lisible que par le serveur (service role) — pas via l’app client.
...
-- Audit : autoriser agent openai (site + Lola)
